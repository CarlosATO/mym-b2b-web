...
- [ ] Fase 6D.5E-B: Carga individual de imágenes desde computador. Próxima fase para subir una imagen real por producto usando el bucket público `product-images` y mantener control de escritura por policies.
